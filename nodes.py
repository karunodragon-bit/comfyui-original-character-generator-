...
def settings_input_spec():
    ...
    return {
        ...
        "weight_xxlarge": ("FLOAT", {"default": balanced["bust_weights"]["xxlarge"], "min": 0.0, "max": 1.0, "step": 0.01}),
        "weight_xxxlarge": ("FLOAT", {"default": balanced["bust_weights"]["xxxlarge"], "min": 0.0, "max": 1.0, "step": 0.01}),
